...
class ProceedToCheckoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      appBar: GeneralAppBar(title: 'Placanje / Checkout'),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Detalji placanja / Payment details',
                  ...
                  AppDivider(),
                  PaymentDetailsItem(
                    title: 'Cena proizvoda / Product price',
                    subtitle: '11466 RSD',
                  ),
                  PaymentDetailsItem(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Adresa dostave / Destination address',
                          style: appTypography.bodyLarge.copyWith(
                            fontWeight: FontWeight.w700,
                          ),
                        ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: AppButton(
          ...
          title: 'Nastavi placanje / Continue to payment',
