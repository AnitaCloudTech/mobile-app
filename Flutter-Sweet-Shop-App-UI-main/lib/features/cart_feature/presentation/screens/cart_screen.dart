...
import 'package:flutter_sweet_shop_app_ui/core/utils/currency_formatter.dart';
...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      ...
      appBar: GeneralAppBar(title: 'Moja korpa / My Cart', showBackIcon: false),
      body: BlocBuilder<CartCubit, CartState>(
        builder: (context, state) {
          if (state is CartInitial) {
            return Center(child: CircularProgressIndicator());
          } else if (state is CartError) {
            return Center(child: Text('Greska / Error: ${state.message}'));
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text('Ukupno / Total:', style: appTypography.bodyLarge),
                          Text(
                            formatRsd(state.totalAmount),
                            style: appTypography.bodyLarge.copyWith(
                      ...
                      AppButton(
                        title: 'Nastavi na placanje / Proceed to checkout',
                        onPressed: () {
