...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
                          ...
                          ListTile(
                            ...
                            leading: SizedBox(
                              ...
                              child: UserProfileImage(
                                imagePath: Assets.images.cupcakeCategory2.path,
                              ),
                            ),
                            title: Text(
                              'Milica Kostic',
                            ...
                            subtitle: Padding(
                              ...
                              child: Text('Milica & Anita Sweet Shop'),
                            ),
  ...
  void _addToCart() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('${product.name} dodat u korpu / added to cart!')),
    );
  }
}
